(function () {
  ...
  function revealTrustedByFallback() {
    ...
    wrap.innerHTML = [
      ...
      '<h2 class="corp-trusted__heading" style="margin:0 0 32px;text-align:center;font-family:\'Darker Grotesque\',sans-serif;font-size:20px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:#111">TRUSTED BY TEAMS WITH TASTE</h2>',
